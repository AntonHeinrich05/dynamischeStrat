...
async def _run_dynamic(job, body, registry, settings, cfg, robust, full_histories,
    ...
    job["phase"] = "Regime-Erkennung: Marktphasen clustern (nur Trainingsdaten)"
    ...
    total_work = (n_regimes + 1) * iterations
    done_work = [0]
    ...
    for r in model["regimes"]:
        ...
        res_r = await dyn.optimize_regime(job, strategy, train_segs, r["id"],
